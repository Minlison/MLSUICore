...
- (UIButton *)rightButton
{
    if (!_rightButton) {
        ...
        _rightButton = [self buttonWithTitle:@"确定"];
...
- (UIImage *)editedImage
{
    ...
    guideRect.origin.x = -self.scrollView.contentOffset.x - horizontalMargin;
    ...
    if (self.cropMode == DZNPhotoEditorViewControllerCropModeCircular) {
        ...
        image =  [image qmui_imageWithClippedCornerRadius:image.size.width * 0.5];
    }
