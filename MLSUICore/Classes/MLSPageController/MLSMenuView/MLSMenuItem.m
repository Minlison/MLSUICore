...
// Getter
- (CGFloat)normalSize {
    if ([CoBaseUtils isPhoneType:(iPhoneTypeInches_4_0)] || [CoBaseUtils isPhoneType:(iPhoneTypeInches_3_5)]) {
        return _normalSize - 2;
    }
    return _normalSize;
}
- (CGFloat)selectedSize {
    if ([CoBaseUtils isPhoneType:(iPhoneTypeInches_4_0)] || [CoBaseUtils isPhoneType:(iPhoneTypeInches_3_5)]) {
        return _selectedSize - 2;
    }
