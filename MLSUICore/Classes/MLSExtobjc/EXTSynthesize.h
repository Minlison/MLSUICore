...
/**
 * \@ext_synthesizeAssociation synthesizes a property for a class using associated
 ...
 */
#define ext_synthesizeAssociation(CLASS, PROPERTY) \
	dynamic PROPERTY; \
	\
	...
	static void ext_ ## CLASS ## _ ## PROPERTY ## _synthesize (void) { \
		...
		\
		NSCAssert(!attributes->weak, @"@ext_synthesizeAssociation does not support weak properties (%@.%s)", cls, # PROPERTY); \
		\
